...
public class CustomClientboundExplodePacket {
    ...
    public CustomClientboundExplodePacket(double pX, double pY, double pZ, float pPower, List<BlockPos> pToBlow,
                                          @Nullable Vec3 pKnockback, ResourceLocation resourceLocation) {
        this.x = pX;
        this.y = pY;
        this.z = pZ;
        this.power = pPower;
