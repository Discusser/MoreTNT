...
public class PrimedFireTNT extends BasePrimedTNT {
    ...
    public PrimedFireTNT(Level pLevel, double pX, double pY, double pZ, float size, boolean fire) {
    ...
    public Explosion createExplosion(double x, double y, double z) {
        return new FireExplosion(this.level, null, null, null, x, y, z, this.size,
