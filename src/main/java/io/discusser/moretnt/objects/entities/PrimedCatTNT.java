...
public class PrimedCatTNT extends BasePrimedTNT {
    ...
    public PrimedCatTNT(Level pLevel, double pX, double pY, double pZ, float size, boolean fire, Direction facing) {
        this(MoreTNTEntities.CAT_TNT.get(), pLevel);
    ...
    public PrimedCatTNT(Level pLevel, double pX, double pY, double pZ, @Nullable LivingEntity pOwner) {
