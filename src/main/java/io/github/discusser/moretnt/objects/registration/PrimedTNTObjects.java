...
import io.github.discusser.moretnt.explosions.*;
...
public class PrimedTNTObjects {
    ...
    public static final PrimedTNTObject DOME_TNT = new PrimedTNTObject(MoreTNTEntities.DOME_TNT, (pLevel, pSource, pDamageSource, pDamageCalculator, pX, pY, pZ, pRadius, pFire, pBlockInteraction, pSmallExplosionParticles, pLargeExplosionParticles, pExplosionSound) -> new SphereExplosion(pLevel, pSource, pDamageSource, pDamageCalculator, pX, pY, pZ, pRadius, pFire, pBlockInteraction, pSmallExplosionParticles, pLargeExplosionParticles, pExplosionSound, Blocks.GLASS, false), SoundEvents.GLASS_PLACE);
